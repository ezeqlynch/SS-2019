...
if __name__ == "__main__":
    ...
    for i in range(len(files)):
        ...
        plt.plot(timesAvg4, linewidth=0.5, color=colors[i])
        plt.plot(timesAvg5, linewidth=0.5, color=colors[i])
    print(means)
    print(stds)
    # print()
    ...
    # plt.axes().xaxis.set_minor_locator(ticker.MultipleLocator(500))
    plt.tight_layout()
    plt.show()
